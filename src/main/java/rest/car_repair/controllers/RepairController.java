...
public class RepairController {
    ...
    public ResponseEntity<ResourceResponse> getRepairs(@PathVariable @Min(1) Long memberId, @PathVariable @Min(1) Long vehicleId)
    ...
    public ResponseEntity<ResourceResponse> getRepair(@PathVariable @Min(1) Long memberId, @PathVariable @Min(1) Long vehicleId, @PathVariable @Min(1) Long repairId)
